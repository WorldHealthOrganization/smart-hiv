...
* pregnancyInHinfectedWoman 0..1 boolean "Pregnancy in HIV-infected woman" "Any HIV diagnosis in a pregnant woman as determined by the national HIV testing algorithm, or a pregnancy in a woman previously diagnosed with HIV"
  * ^code[+] = HIVConcepts#HIV.E.DE37
* dateNewPregnancyOfHiositiveWomanIdentified 0..1 date "Date new pregnancy of HIV-positive woman identified" "Earliest date when a new pregnancy of an HIV-positive woman is recorded"
...
* liveBirthToAnHiositiveWoman 0..1 boolean "Live birth to an HIV-positive woman" "A woman living with HIV had a live birth"
...
* infantCrimoxazoleProphylaxisStartDate 0..1 date "Infant's co-trimoxazole prophylaxis start date" "Start date of co-trimoxazole prophylaxis"
  * ^code[+] = HIVConcepts#HIV.E.DE163
* infantAgeWhenCrimoxazoleProphylaxisWasStarted 0..1 integer "Infant's age when co-trimoxazole prophylaxis was started" "The number of weeks or months infant was when started on co-trimoxazole (CTX) prophylaxis preventive therapy"
...
* finalDiagnosisOfHixposedInfant 0..1 Coding "Final diagnosis of HIV-exposed infant" "HIV-exposed infant final status at 18 months or 3 months after cessation of breastfeeding (whichever is later)."
  * ^code[+] = HIVConcepts#HIV.E.DE230
  * finalDiagnosisOfHixposedInfant from HIV.E.DE230"
