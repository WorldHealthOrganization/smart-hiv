...
* originalFirsineArtRegimen 0..1 Coding "Original first-line ART regimen" "Original full, first-line ARV drug regimen patient started on at this facility"
  * ^code[+] = HIVConcepts#HIV.D.DE74
  * originalFirsineArtRegimen from HIV.D.DE74"
...
* preferredFirsineArtRegimen 0..1 Coding "Preferred first-line ART regimen" "The preferred first-line ART regimen for the client according to WHO (or national) guidelines"
  * ^code[+] = HIVConcepts#HIV.D.DE77
  * preferredFirsineArtRegimen from HIV.D.DE77"
* alternativeFirsineArtRegimen 0..1 Coding "Alternative first-line ART regimen" "The alternative first-line ART regimen for the client according to WHO (or national) guidelines"
  * ^code[+] = HIVConcepts#HIV.D.DE78
  * alternativeFirsineArtRegimen from HIV.D.DE78"
* firsineArtRegimenUnderSpecialCircumstances 0..1 Coding "First-line ART regimen under special circumstances" "The first-line ART regimen for the client under special circumstances according to WHO (or national) guidelines"
  * ^code[+] = HIVConcepts#HIV.D.DE79
  * firsineArtRegimenUnderSpecialCircumstances from HIV.D.DE79"
* preferredSeconineArtRegimen 0..1 Coding "Preferred second-line ART regimen" "The preferred second-line ART regimen for the client according to WHO (or national) guidelines"
  * ^code[+] = HIVConcepts#HIV.D.DE80
  * preferredSeconineArtRegimen from HIV.D.DE80"
* alternativeSeconineArtRegimen 0..1 Coding "Alternative second-line ART regimen" "The alternative second-line ART regimen for the client according to WHO (or national) guidelines"
  * ^code[+] = HIVConcepts#HIV.D.DE81
  * alternativeSeconineArtRegimen from HIV.D.DE81"
...
* currentlyOnTdasedArt 0..1 boolean "Currently on TDF-based ART" "Client is currently on TDF-based ART regimen"
...
* reasonArtStopped 0..1 Coding "Reason ART stopped" "Reason client intentionally stopped ART"
...
* whoHivClinicalStageConditionOrSymptom 0..1 Coding "WHO HIV clinical stage condition or symptom" "New or recurrent clinical events used to categorize HIV disease severity based at baseline and follow up"
...
* reasonsForDelayedArtInitiation 0..1 Coding "Reasons for delayed ART initiation" "Reason why ART was not initiated at diagnosis or within 7 days of diagnosis"
...
* reasonForArvDrugRegimenSubstitution 0..1 Coding "Reason for ARV drug regimen substitution" "Reason why a substitution was made to the antiretroviral (ARV) drug regimen"
...
* switchToSeconineArtRegimenRecommended 0..1 boolean "Switch to second-line ART regimen recommended" "A switch to second-line ART regimen is recommended"
  * ^code[+] = HIVConcepts#HIV.D.DE427
* switchToThirineArtRegimenRecommended 0..1 boolean "Switch to third-line ART regimen recommended" "A switch to third-line ART regimen is recommended"
...
* coinfectionStatusAtArtStart 0..1 Coding "Coinfection status at ART start" "Clients status of coinfections at the time when ART was initiated"
  * ^code[+] = HIVConcepts#HIV.D.DE446
  * coinfectionStatusAtArtStart from HIV.D.DE446"
* pregnantAndBreastfeedingStatusAtArtStart 0..1 Coding "Pregnant and breastfeeding status at ART start" "ART status of women to prevent mother-to-child transmission"
...
* dateIptpDoseProvided 0..1 date "Date IPTp-SP dose provided" "Date on which the IPTp-SP dose was provided"
...
* dsdArtModel 0..1 Coding "DSD ART model(s)" "Type of DSD ART model client is enrolled in (country-specific)"
...
* mipperArmCircumference 0..1 integer "Mid-upper arm circumference (MUAC)" "Client's mid-upper arm circumference (MUAC)"
