...
* datimeOfSuspectedExposureToHiv 0..1 dateTime "Date/time of suspected exposure to HIV" "Date and time when the client had suspected exposure to HIV"
...
* hasUsedAnHivSelestBefore 0..1 boolean "Has used an HIV self-test before (reported)" "The client reported having used an HIV self-test before"
...
* dateOfHivSelest 0..1 date "Date of HIV self-test" "Date when the HIV self-test was conducted"
...
* dateInformedOfHiositiveDiagnosis 0..1 date "Date informed of HIV-positive diagnosis" "The date on which the client was diagnosed with HIV"
...
* otherReasonForTheFollopAppointment 0..1 string "Other reason for the follow-up appointment (specify)" "Other reason for the follow-up appointment (specify)"
...
* typeOfAdverseVmmcEvent 0..1 Coding "Type of adverse VMMC event" "Type of adverse event associated with voluntary medical male circumcision (VMMC) procedure"
