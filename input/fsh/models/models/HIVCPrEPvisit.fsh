...
* onthPrepVisit 0..1 boolean "3-month PrEP visit" "Client is visiting for the recommended 3-month pre-exposure prophylaxis (PrEP) visit"
...
* datimeOfSuspectedExposureToHiv 0..1 dateTime "Date/time of suspected exposure to HIV" "When the suspect exposure to HIV took place"
...
* usedEvenrivenPrepForAtRiskExposuresOverThePast_3Months 0..1 boolean "Used event-driven PrEP for at risk exposures over the past 3 months" "Client reports taking ED-PrEP for at risk exposures over a 3-month period"
...
* signsOfSubstantialRiskOfHivInfection 1..1 Coding "Signs of substantial risk of HIV infection" "Signs the client is at a substantial risk of HIV infection"
...
* acuteHivInfectionSymptoms 0..1 Coding "Acute HIV infection symptoms" "Symptoms that could suggest an acute HIV infection"
  * ^code[+] = HIVConcepts#HIV.C.DE46
  * acuteHivInfectionSymptoms from HIV.C.DE46"
* sexPartnerHivTreatmentStatus 0..1 Coding "Sex partner's HIV treatment status" "Treatment adherence of client's sex partner for partners that are HIV-positive"
...
* screeningsAndDiagnosticsForPrepUsers 0..1 Coding "Screenings and diagnostics for PrEP users" "Listing of tests for clients on or starting pre-exposure prophylaxis (PrEP) that may be recommended or should be considered"
...
* volumeOfPrepProductPrescribeispensed 0..1 integer "Volume of PrEP product prescribed/dispensed" "Volume of PrEP product the client was prescribed or dispensed (for example, number of pills, number of devices)"
...
* alternativePepBackboneRegimen 0..1 Coding "Alternative PEP backbone regimen" "Alternative backbone regimen for PEP"
  * ^code[+] = HIVConcepts#HIV.C.DE95
  * alternativePepBackboneRegimen from HIV.C.DE95"
* preferredThirdPepDrug 0..1 Coding "Preferred third PEP drug" "Preferred third drug for PEP"
  * ^code[+] = HIVConcepts#HIV.C.DE99
  * preferredThirdPepDrug from HIV.C.DE99"
* alternativeThirdPepDrug 0..1 Coding "Alternative third PEP drug" "Alternative third drug for PEP"
...
* contraindicationsToPrepUsage 0..1 Coding "Contraindications to PrEP usage" "Listing of contraindications to pre-exposure prophylaxis (PrEP)"
...
* numberOfHivSelestKitsDistributed 0..1 integer "Number of HIV self-test kits distributed" "Number of HIV self-test kits distributed to the client"
