...
* reasonHepatitisBTestNotConducted 0..1 Coding "Reason Hepatitis B test not conducted" "Reason why a hepatitis B test was not done"
...
* reasonHepatitisCTestNotDone 0..1 Coding "Reason Hepatitis C test not done" "Reason why a hepatitis C test was not done"
