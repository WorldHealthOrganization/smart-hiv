...
* emergencyReferral 1..1 boolean "Emergency referral" "Referral for urgent care" 
  * ^code[+] = HIVConcepts#I.DE1 
* reasonForReferral 1..1 Coding "Reason for referral" "Reason why the client is being referred. If diagnosed, this may include the reason for the diagnosis." 
  * ^code[+] = HIVConcepts#I.DE2 
  * reasonForReferral from HIV.I.DE2" 
* referralForOtherGeneralServicespecify) 0..1 string "Referral for other general services (specify)" "If none of the reasons above apply, specify the reason(s)" 
  * ^code[+] = HIVConcepts#I.DE8 
...
* locationOfScheduledReferralAppointment 1..1 string "Location of scheduled referral appointment" "Where the client is being referred to" 
  * ^code[+] = HIVConcepts#I.DE11 
* dateReferralWasMade 1..1 dateTime "Date referral was made" "The date the referral was made" 
  * ^code[+] = HIVConcepts#I.DE12 
* providerWhoMadeReferral 1..1 string "Provider who made referral" "The name of the provider who made the referral" 
  * ^code[+] = HIVConcepts#I.DE13 
* provideFacility 1..1 string "Provider's facility" "Facility client is being referred from" 
  * ^code[+] = HIVConcepts#I.DE14 
* provideTelephoneNumber 1..1 integer "Provider's telephone number" "The contact details of the provider making the referral" 
  * ^code[+] = HIVConcepts#I.DE15 
