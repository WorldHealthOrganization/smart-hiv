...
|---|---|---|---|---|
|HIV.A.DE1|First name|Client's first or given name|string|[Observation.value[x]](StructureDefinition-hiv-a-de1.html)|
|HIV.A.DE10|National health ID|National health unique identifier assigned to the client, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-a-de10.html)|
|HIV.A.DE11|National programme ID|National programme unique identifier assigned to the client, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-a-de11.html)|
|HIV.A.DE12|National health insurance ID|National health insurance unique identifier assigned to the client, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-a-de12.html)|
|HIV.A.DE13|Country of birth|Country where the client was born|string|[Observation.value[x]](StructureDefinition-hiv-a-de13.html)|
|HIV.A.DE14|Date of birth|The client's date of birth (DOB) if known|string|[Observation.value[x]](StructureDefinition-hiv-a-de14.html)|
|HIV.A.DE15|Date of birth unknown|Is the client's DOB is unknown?|string|[Observation.value[x]](StructureDefinition-hiv-a-de15.html)|
...
|HIV.A.DE18|Gender*|Gender of the client*|string|[Observation.value[x]](StructureDefinition-hiv-a-de18.html)|
|HIV.A.DE2|Family name|Client's family name or last name|string|[Observation.value[x]](StructureDefinition-hiv-a-de2.html)|
|HIV.A.DE24|Other (specify)|Additional category (please specify)|string|[Observation.value[x]](StructureDefinition-hiv-a-de24.html)|
|HIV.A.DE25|Sex|Sex of the client assigned at birth|string|[Observation.value[x]](StructureDefinition-hiv-a-de25.html)|
|HIV.A.DE29|Address|Client's home address or address which the client is consenting to disclose|string|[Observation.value[x]](StructureDefinition-hiv-a-de29.html)|
...
|HIV.A.DE30|Marital Status|Client's current marital status|string|[Observation.value[x]](StructureDefinition-hiv-a-de30.html)|
|HIV.A.DE4|Referral|If client was referred for care|string|[Observation.value[x]](StructureDefinition-hiv-a-de4.html)|
|HIV.A.DE42|Telephone number|Client's telephone number (a landline or a mobile phone number)|string|[Observation.value[x]](StructureDefinition-hiv-a-de42.html)|
|HIV.A.DE43|[Administrative Area]|This should be a context-specific list of administrative areas, such as villages, districts, etc. The purpose of this data element is to allow for grouping and flagging of client data to a particular facility's catchment area. This can be input into the system by the end user OR it can be automated in the database based on the end user's attributes.|string|[Observation.value[x]](StructureDefinition-hiv-a-de43.html)|
|HIV.A.DE44|Communication consent|Indication that client gave consent to be contacted|string|[Observation.value[x]](StructureDefinition-hiv-a-de44.html)|
|HIV.A.DE45|Reminder messages|Whether client wants to receive text or other messages as follow-up for HIV services|string|[Observation.value[x]](StructureDefinition-hiv-a-de45.html)|
|HIV.A.DE46|Communication preference(s)|How the client would like to receive family planning communications|string|[Observation.value[x]](StructureDefinition-hiv-a-de46.html)|
|HIV.A.DE49|Client's email|Client's primary email account where the client can be contacted|string|[Observation.value[x]](StructureDefinition-hiv-a-de49.html)|
|HIV.A.DE5|Referred by|How the client was referred|string|[Observation.value[x]](StructureDefinition-hiv-a-de5.html)|
|HIV.A.DE50|Alternate contact's name|Name of an alternate contact, which could be next of kin (e.g. partner, husband, mother, sibling, etc.). The alternate contact would be used in the case of an emergency situation.|string|[Observation.value[x]](StructureDefinition-hiv-a-de50.html)|
|HIV.A.DE51|Alternate contact's phone number|Phone number of the alternate contact|string|[Observation.value[x]](StructureDefinition-hiv-a-de51.html)|
|HIV.A.DE52|Alternate contact's address|Alternate contact's home address or address which the client is consenting to disclose|string|[Observation.value[x]](StructureDefinition-hiv-a-de52.html)|
|HIV.A.DE53|Alternate contact relationship|The alternate contact's relationship to the client (e.g. partner, husband, mother, sibling, etc.)|string|[Observation.value[x]](StructureDefinition-hiv-a-de53.html)|
|HIV.A.DE8|Unique identifier|Unique identifier generated for new clients or a universal ID, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-a-de8.html)|
|HIV.A.DE9|National ID|National unique identifier assigned to the client, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-a-de9.html)|
|HIV.B.DE1|Reason for visit|Reason for HIV testing services visit|string|[Observation.value[x]](StructureDefinition-hiv-b-de1.html)|
|HIV.B.DE102|Test result of HIV assay 3|The result of the third HIV assay in the testing strategy|string|[Observation.value[x]](StructureDefinition-hiv-b-de102.html)|
|HIV.B.DE106|Test result of HIV assay 1 repeated|The result of the repeated first HIV assay in the testing strategy|string|[Observation.value[x]](StructureDefinition-hiv-b-de106.html)|
|HIV.B.DE110|HIV test date|Date of the HIV test|string|[Observation.value[x]](StructureDefinition-hiv-b-de110.html)|
|HIV.B.DE111|HIV test result|The result from HIV testing after applying the testing algorithm|string|[Observation.value[x]](StructureDefinition-hiv-b-de111.html)|
...
|HIV.B.DE195|Date/time of follow-up appointment|Date the patient is to return for monitoring, re-supply or any other reason|string|[Observation.value[x]](StructureDefinition-hiv-b-de195.html)|
...
|HIV.B.DE300|POC Test type for Trichomonas vaginalis test (specify)|Point-of-care (POC) test used (specify)|string|[Observation.value[x]](StructureDefinition-hiv-b-de300.html)|
...
|HIV.B.DE73|Age at diagnosis|The client's age (in years) when given an HIV diagnosis|string|[Observation.value[x]](StructureDefinition-hiv-b-de73.html)|
...
|HIV.C.DE138|Condom type|Type of condom provided to client|string|[Observation.value[x]](StructureDefinition-hiv-c-de138.html)|
...
|HIV.C.DE90|Date PEP course completion|Date client completes PEP course|string|[Observation.value[x]](StructureDefinition-hiv-c-de90.html)|
...
|HIV.D.DE1017|Eligible for TB preventive treatment|Client is eligible for tuberculosis preventive treatment (TPT)|string|[Observation.value[x]](StructureDefinition-hiv-d-de1017.html)|
...
|HIV.D.DE382|ART initiated within 7 days of diagnosis|Client initiated ART within 7 days of diagnosis|string|[Observation.value[x]](StructureDefinition-hiv-d-de382.html)|
...
|HIV.D.DE446|Coinfection status at ART start|Clients status of coinfections at the time when ART was initiated|string|[Observation.value[x]](StructureDefinition-hiv-d-de446.html)|
...
|HIV.D.DE492|Reason for switch to third-line regimen|Reason why client was switched from second- to third-line ARV drug regimen (see "Reason for regimen switch" for levels)|string|[Observation.value[x]](StructureDefinition-hiv-d-de492.html)|
...
|HIV.D.DE653|AIDS-related death|Death of client was AIDS-related|string|[Observation.value[x]](StructureDefinition-hiv-d-de653.html)|
...
|HIV.D.DE76|Current ART regimen start date|The date on which the client started taking the current ART regimen|string|[Observation.value[x]](StructureDefinition-hiv-d-de76.html)|
...
|HIV.D.DE897|WHO functional status|Functional status of people with advanced HIV disease|string|[Observation.value[x]](StructureDefinition-hiv-d-de897.html)|
...
|HIV.E.DE108|Infant or child exposure to HIV|Whether the infant or child was determined to have had HIV exposure through mother|string|[Observation.value[x]](StructureDefinition-hiv-e-de108.html)|
...
|HIV.E.DE164|Infant's age when co-trimoxazole prophylaxis was started|The number of weeks or months infant was when started on co-trimoxazole (CTX) prophylaxis preventive therapy|string|[Observation.value[x]](StructureDefinition-hiv-e-de164.html)|
|HIV.E.DE165|Presumptive clinical diagnosis of severe HIV infection in infants|Presumptive clinical diagnosis of severe HIV infection in infants|string|[Observation.value[x]](StructureDefinition-hiv-e-de165.html)|
|HIV.E.DE166|Infant ARV prophylaxis|Infant is taking an antiretroviral prophylaxis to prevent infection from HIV exposure|string|[Observation.value[x]](StructureDefinition-hiv-e-de166.html)|
|HIV.E.DE167|Infant ARV prophylaxis start date|The date on which the infant was started on an antiretroviral prophylaxis|string|[Observation.value[x]](StructureDefinition-hiv-e-de167.html)|
|HIV.E.DE17|Past pregnancy complications|Whether the woman has had any complications or problems in any previous pregnancy|string|[Observation.value[x]](StructureDefinition-hiv-e-de17.html)|
|HIV.E.DE173|Maternal and child health service visit|Maternal and child health service visit attended by an HIV-exposed infant|string|[Observation.value[x]](StructureDefinition-hiv-e-de173.html)|
|HIV.E.DE177|Weeks postpartum|Number of weeks postpartum on this visit date|string|[Observation.value[x]](StructureDefinition-hiv-e-de177.html)|
|HIV.E.DE178|Birth cohort|Month and year of infant's birth, which the infant is registered into. The cohort is a group of infants born in the same month, whose status is followed over time.|string|[Observation.value[x]](StructureDefinition-hiv-e-de178.html)|
|HIV.E.DE179|Registered in birth cohort|Whether the infant has been registered in a birth cohort|string|[Observation.value[x]](StructureDefinition-hiv-e-de179.html)|
|HIV.E.DE180|EID sample number|Early infant diagnosis (EID) sample number|string|[Observation.value[x]](StructureDefinition-hiv-e-de180.html)|
|HIV.E.DE181|EID sample 1|First sample used to test an infant for HIV|string|[Observation.value[x]](StructureDefinition-hiv-e-de181.html)|
|HIV.E.DE182|EID sample 2|Second sample used to test an infant for HIV|string|[Observation.value[x]](StructureDefinition-hiv-e-de182.html)|
|HIV.E.DE183|EID test number|Early infant diagnosis (EID) HIV test number using the same sample|string|[Observation.value[x]](StructureDefinition-hiv-e-de183.html)|
|HIV.E.DE184|EID test number 1|First test on a sample to test an infant for HIV|string|[Observation.value[x]](StructureDefinition-hiv-e-de184.html)|
|HIV.E.DE185|EID test number 2|Second test on a sample to test an infant for HIV|string|[Observation.value[x]](StructureDefinition-hiv-e-de185.html)|
|HIV.E.DE186|EID test number 1 test result|Early infant diagnosis test number 1 test result|string|[Observation.value[x]](StructureDefinition-hiv-e-de186.html)|
|HIV.E.DE190|EID test number 2 test result|Early infant diagnosis test number 2 test result|string|[Observation.value[x]](StructureDefinition-hiv-e-de190.html)|
|HIV.E.DE2|Pregnant woman's surname|Pregnant woman's family name or last name|string|[Observation.value[x]](StructureDefinition-hiv-e-de2.html)|
|HIV.E.DE216|Test result of syphilis assay 1|The result of the first syphilis assay in the testing strategy|string|[Observation.value[x]](StructureDefinition-hiv-e-de216.html)|
|HIV.E.DE220|Test result of syphilis assay 1 repeated|The result of the first syphilis assay repeated in the testing strategy|string|[Observation.value[x]](StructureDefinition-hiv-e-de220.html)|
|HIV.E.DE225|Infant HIV status|HIV status reported after applying the HIV testing algorithm. No single HIV test can provide an HIV-positive diagnosis.|string|[Observation.value[x]](StructureDefinition-hiv-e-de225.html)|
|HIV.E.DE229|Infant ART start date|The date on which the infant was started or restarted on antiretroviral therapy (ART)|string|[Observation.value[x]](StructureDefinition-hiv-e-de229.html)|
|HIV.E.DE230|Final diagnosis of HIV-exposed infant|HIV-exposed infant final status at 18 months or 3 months after cessation of breastfeeding (whichever is later).|string|[Observation.value[x]](StructureDefinition-hiv-e-de230.html)|
|HIV.E.DE234|HIV-exposed infant reason for unknown final status|The outcome for the infant does not have a final outcome, which may because of death, stopped treatment or lost to follow-up.|string|[Observation.value[x]](StructureDefinition-hiv-e-de234.html)|
|HIV.E.DE239|Date of death of infant|Date that the infant died|string|[Observation.value[x]](StructureDefinition-hiv-e-de239.html)|
|HIV.E.DE240|Cause of death of infant|The infant's cause of death|string|[Observation.value[x]](StructureDefinition-hiv-e-de240.html)|
|HIV.E.DE241|Infant died within 24 hours of childbirth|The infant died within 24 hours of childbirth|string|[Observation.value[x]](StructureDefinition-hiv-e-de241.html)|
|HIV.E.DE242|Action(s) needed during infant follow-up visit|Any actions needed during infant follow-up visit|string|[Observation.value[x]](StructureDefinition-hiv-e-de242.html)|
|HIV.E.DE243|Timing of additional infant HIV test|Age in months when additional infant HIV test is performed|string|[Observation.value[x]](StructureDefinition-hiv-e-de243.html)|
|HIV.E.DE244|Date of sample collection of additional infant HIV test|Date of sample collection of additional infant HIV test|string|[Observation.value[x]](StructureDefinition-hiv-e-de244.html)|
|HIV.E.DE245|Haemoglobin (Hb) result|Result of woman's haemoglobin test during ANC, labour or delivery. Full blood count testing is recommended, and if not available, use of  haemoglobinometer over haemoglobin colour scale.|string|[Observation.value[x]](StructureDefinition-hiv-e-de245.html)|
|HIV.E.DE246|Blood group and Rh factor|Mother's blood type and blood Rh factor|string|[Observation.value[x]](StructureDefinition-hiv-e-de246.html)|
|HIV.E.DE255|Asymptomatic bacteriuria (ASB) test result|Result of urine culture (or urine Gram-staining if not available over dipstick tests) for diagnosing asymptomatic bacteriuria|string|[Observation.value[x]](StructureDefinition-hiv-e-de255.html)|
|HIV.E.DE259|Urine protein test result|Results of urine protein test of mother during ANC visit|string|[Observation.value[x]](StructureDefinition-hiv-e-de259.html)|
|HIV.E.DE264|Type of hypertensive disorder|Type of hypertensive disorder of the mother|string|[Observation.value[x]](StructureDefinition-hiv-e-de264.html)|
|HIV.E.DE3|Pregnant woman's unique ID|Unique identifier generated for new clients or a universal ID, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-e-de3.html)|
|HIV.E.DE35|Other past pregnancy problems (specify)|Woman experienced other past pregnancy problems not described above (specify)|string|[Observation.value[x]](StructureDefinition-hiv-e-de35.html)|
|HIV.E.DE37|Pregnancy in HIV-infected woman|Any HIV diagnosis in a pregnant woman as determined by the national HIV testing algorithm, or a pregnancy in a woman previously diagnosed with HIV|string|[Observation.value[x]](StructureDefinition-hiv-e-de37.html)|
|HIV.E.DE38|Date new pregnancy of HIV-positive woman identified|Earliest date when a new pregnancy of an HIV-positive woman is recorded|string|[Observation.value[x]](StructureDefinition-hiv-e-de38.html)|
|HIV.E.DE39|ANC contact during pregnancy|Whether the mother had at least one ANC contact (visit)|string|[Observation.value[x]](StructureDefinition-hiv-e-de39.html)|
|HIV.E.DE4|Antenatal care number|Identification number assigned to woman at first visit to the ANC based on national system|string|[Observation.value[x]](StructureDefinition-hiv-e-de4.html)|
|HIV.E.DE40|Date of first ANC visit|Date of the pregnant woman's first ANC visit|string|[Observation.value[x]](StructureDefinition-hiv-e-de40.html)|
|HIV.E.DE41|Timing of ART initiation|When the pregnant woman or mother initiated ART, for women living with HIV.|string|[Observation.value[x]](StructureDefinition-hiv-e-de41.html)|
|HIV.E.DE45|Maternal use of recommended ART regimen|Whether the mother is taking a recommended ART regimen|string|[Observation.value[x]](StructureDefinition-hiv-e-de45.html)|
|HIV.E.DE46|Delivery date|Date on which the woman delivered|string|[Observation.value[x]](StructureDefinition-hiv-e-de46.html)|
|HIV.E.DE47|Pregnancy outcome|Outcome of current pregnancy|string|[Observation.value[x]](StructureDefinition-hiv-e-de47.html)|
|HIV.E.DE52|Delivery mode|Mode of delivery for current pregnancy|string|[Observation.value[x]](StructureDefinition-hiv-e-de52.html)|
|HIV.E.DE56|Indications for caesarian section (C/S)|Indications for caesarian section|string|[Observation.value[x]](StructureDefinition-hiv-e-de56.html)|
|HIV.E.DE57|Obstetric complications|Serious or life-threatening obstetric complications during pregnancy, delivery or postpartum experienced by mother or her newborn|string|[Observation.value[x]](StructureDefinition-hiv-e-de57.html)|
|HIV.E.DE58|Live birth|The woman had a live birth|string|[Observation.value[x]](StructureDefinition-hiv-e-de58.html)|
|HIV.E.DE59|Live birth to an HIV-positive woman|A woman living with HIV had a live birth|string|[Observation.value[x]](StructureDefinition-hiv-e-de59.html)|
|HIV.E.DE6|Source of gestational age|Gestational age can be calculated multiple ways. This data element describes where the gestational age above has been calculated from.|string|[Observation.value[x]](StructureDefinition-hiv-e-de6.html)|
|HIV.E.DE60|Gestational age at birth|Best estimate of gestational age in completed weeks when infant was born (an indication of prematurity, preterm and extreme preterm)|string|[Observation.value[x]](StructureDefinition-hiv-e-de60.html)|
|HIV.E.DE61|Small for gestational age (SGA)|Whether the infant was small for gestational age (SGA) at birth (<10th percentile)|string|[Observation.value[x]](StructureDefinition-hiv-e-de61.html)|
|HIV.E.DE62|Preterm birth status|The woman gave birth when the gestational age is less than 37 weeks|string|[Observation.value[x]](StructureDefinition-hiv-e-de62.html)|
|HIV.E.DE66|Maternal ART start date|The date on which the infant was started or restarted on ART|string|[Observation.value[x]](StructureDefinition-hiv-e-de66.html)|
|HIV.E.DE67|Place of delivery|The type of place where the woman delivered|string|[Observation.value[x]](StructureDefinition-hiv-e-de67.html)|
|HIV.E.DE72|Delivery facility|Facility where the infant or child was born|string|[Observation.value[x]](StructureDefinition-hiv-e-de72.html)|
|HIV.E.DE73|Date of miscarriage or abortion|Date of the miscarriage/abortion|string|[Observation.value[x]](StructureDefinition-hiv-e-de73.html)|
|HIV.E.DE74|Date of death of mother|Date that the woman died|string|[Observation.value[x]](StructureDefinition-hiv-e-de74.html)|
|HIV.E.DE75|Cause of death of mother|The woman's cause of death|string|[Observation.value[x]](StructureDefinition-hiv-e-de75.html)|
|HIV.E.DE76|Infant's first name|Infant's first or given name|string|[Observation.value[x]](StructureDefinition-hiv-e-de76.html)|
|HIV.E.DE77|Infant's surname|Infant's family name or last name|string|[Observation.value[x]](StructureDefinition-hiv-e-de77.html)|
|HIV.E.DE78|Infant's unique ID|Unique identifier generated for new clients or a universal ID, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-e-de78.html)|
|HIV.E.DE79|Mother's first name|Biological mother's first or given name|string|[Observation.value[x]](StructureDefinition-hiv-e-de79.html)|
|HIV.E.DE80|Mother's surname|Biological mother's family name or last name|string|[Observation.value[x]](StructureDefinition-hiv-e-de80.html)|
|HIV.E.DE81|Mother's unique ID|Unique identifier generated for new clients or a universal ID, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-e-de81.html)|
|HIV.E.DE82|Caregiver's first name|Caregiver's first or given name|string|[Observation.value[x]](StructureDefinition-hiv-e-de82.html)|
|HIV.E.DE83|Caregiver's surname|Caregiver's family name or last name|string|[Observation.value[x]](StructureDefinition-hiv-e-de83.html)|
|HIV.E.DE84|Caregiver's unique identifier|Unique identifier generated for new clients or a universal ID, if used in the country|string|[Observation.value[x]](StructureDefinition-hiv-e-de84.html)|
|HIV.E.DE85|ANC contact date|The date and time of the client's ANC contact (in the ANC DAK this is called 'Contact date')|string|[Observation.value[x]](StructureDefinition-hiv-e-de85.html)|
|HIV.E.DE87|Infant date of birth|The infant's date of birth (DOB) if known|string|[Observation.value[x]](StructureDefinition-hiv-e-de87.html)|
|HIV.E.DE88|Date of birth of infant unknown|Is the client's DOB unknown?|string|[Observation.value[x]](StructureDefinition-hiv-e-de88.html)|
|HIV.E.DE89|Estimated age of infant|If DOB is unknown, enter the client's estimated age. Display client's age in number of years|string|[Observation.value[x]](StructureDefinition-hiv-e-de89.html)|
|HIV.E.DE90|Age of infant|Infant age calculated using date of birth|string|[Observation.value[x]](StructureDefinition-hiv-e-de90.html)|
|HIV.E.DE91|Gender of infant|Gender of the infant|string|[Observation.value[x]](StructureDefinition-hiv-e-de91.html)|
|HIV.E.DE95|Infant height|The infant's height in centimetres|string|[Observation.value[x]](StructureDefinition-hiv-e-de95.html)|
|HIV.E.DE96|Infant weight|The infant's current weight in kilograms|string|[Observation.value[x]](StructureDefinition-hiv-e-de96.html)|
|HIV.E.DE97|Birth weight|Birth weight in kg of the baby|string|[Observation.value[x]](StructureDefinition-hiv-e-de97.html)|
|HIV.E.DE98|Low birth weight|Note if infant </¬≥2500 g at birth|string|[Observation.value[x]](StructureDefinition-hiv-e-de98.html)|
|HIV.E.DE99|Length of infant|Length of infant at birth in cm|string|[Observation.value[x]](StructureDefinition-hiv-e-de99.html)|
|HIV.G.DE10|Date viral load sample sent|Date viral load sample sent to the lab|string|[Observation.value[x]](StructureDefinition-hiv-g-de10.html)|
|HIV.G.DE11|First viral load test result|Result from the initial viral load test in number of copies/mL|string|[Observation.value[x]](StructureDefinition-hiv-g-de11.html)|
|HIV.G.DE13|HIV viral load specimen type|The type of specimen to be used to test viral load|string|[Observation.value[x]](StructureDefinition-hiv-g-de13.html)|
|HIV.G.DE22|Reason Hepatitis B test not conducted|Reason why a hepatitis B test was not done|string|[Observation.value[x]](StructureDefinition-hiv-g-de22.html)|
|HIV.G.DE29|Hepatitis B diagnosis|Client's hepatitis B diagnosis|string|[Observation.value[x]](StructureDefinition-hiv-g-de29.html)|
|HIV.G.DE32|Hepatitis C screening date|Date when client was screened for HCV|string|[Observation.value[x]](StructureDefinition-hiv-g-de32.html)|
|HIV.G.DE34|Hepatitis C test conducted|Whether a hepatitis C test was conducted|string|[Observation.value[x]](StructureDefinition-hiv-g-de34.html)|
|HIV.G.DE35|Reason Hepatitis C test not done|Reason why a hepatitis C test was not done|string|[Observation.value[x]](StructureDefinition-hiv-g-de35.html)|
|HIV.G.DE4|Date of baseline CD4 count sample collection|Date and time when baseline CD4 count test sample was collected|string|[Observation.value[x]](StructureDefinition-hiv-g-de4.html)|
|HIV.G.DE51|Hepatitis C diagnosis|Client's hepatitis C diagnosis|string|[Observation.value[x]](StructureDefinition-hiv-g-de51.html)|
|HIV.G.DE6|Date of CD4 sample collection|Date sample to be used for CD4 count was collected|string|[Observation.value[x]](StructureDefinition-hiv-g-de6.html)|
|HIV.G.DE62|Reason syphilis test not done|Reason why a syphilis test was not done|string|[Observation.value[x]](StructureDefinition-hiv-g-de62.html)|
|HIV.G.DE7|Viral load test conducted|A viral load test was performed|string|[Observation.value[x]](StructureDefinition-hiv-g-de7.html)|
|HIV.G.DE74|Syphilis diagnosis|Client's syphilis diagnosis|string|[Observation.value[x]](StructureDefinition-hiv-g-de74.html)|
|HIV.G.DE77|Other tests conducted|If the health worker performed other tests on the woman that are not explicitly listed in the application, select "yes" here and fill in the details below.|string|[Observation.value[x]](StructureDefinition-hiv-g-de77.html)|
|HIV.G.DE78|Other test(s) name|Input the name of other test(s) that were done.|string|[Observation.value[x]](StructureDefinition-hiv-g-de78.html)|
|HIV.G.DE79|Other test(s) date|Input the date of other test(s) that were done.|string|[Observation.value[x]](StructureDefinition-hiv-g-de79.html)|
|HIV.G.DE80|Other test(s) result(s)|Input the result from the test(s).|string|[Observation.value[x]](StructureDefinition-hiv-g-de80.html)|
|HIV.G.DE9|Date of first viral load sample collection|Date and time when the sample was collected to test the client's HIV viral load for the first time|string|[Observation.value[x]](StructureDefinition-hiv-g-de9.html)|
...
|HIV.H.DE10|Client contact attempted|An attempt to locate the client was made|string|[Observation.value[x]](StructureDefinition-hiv-h-de10.html)|
|HIV.H.DE11|Date of contact attempt|Date of attempt to contact client|string|[Observation.value[x]](StructureDefinition-hiv-h-de11.html)|
|HIV.H.DE12|Contact attempted by|Who attempted to reach out to the client|string|[Observation.value[x]](StructureDefinition-hiv-h-de12.html)|
|HIV.H.DE13|Contact method|Method used to try to reach out to the client|string|[Observation.value[x]](StructureDefinition-hiv-h-de13.html)|
|HIV.H.DE17|Source of information|Source of information about the client|string|[Observation.value[x]](StructureDefinition-hiv-h-de17.html)|
|HIV.H.DE22|Other source of information (specify)|Information about the client's status was provided by someone else (specify)|string|[Observation.value[x]](StructureDefinition-hiv-h-de22.html)|
|HIV.H.DE23|Outcome from outreach attempt|Detailed outcome from the attempt to locate the client|string|[Observation.value[x]](StructureDefinition-hiv-h-de23.html)|
|HIV.H.DE30|Moved from catchment area|The client moved from the catchment area (may be reported from the community level)|string|[Observation.value[x]](StructureDefinition-hiv-h-de30.html)|
|HIV.H.DE31|Date client moved from catchment area|The date on which the client moved from the catchment area, if known|string|[Observation.value[x]](StructureDefinition-hiv-h-de31.html)|
|HIV.H.DE32|New catchment area|New catchment area where the client resides|string|[Observation.value[x]](StructureDefinition-hiv-h-de32.html)|
|HIV.H.DE33|Partner or contact of index case|The client was identified by an index case as a partner or contact|string|[Observation.value[x]](StructureDefinition-hiv-h-de33.html)|
|HIV.H.DE34|HIV status of partner or contact|HIV status of the partner or contact given by the index case|string|[Observation.value[x]](StructureDefinition-hiv-h-de34.html)|
|HIV.H.DE39|Cause of death|Cause of death, if known|string|[Observation.value[x]](StructureDefinition-hiv-h-de39.html)|
|HIV.H.DE40|Place of death|Where the client died, if known|string|[Observation.value[x]](StructureDefinition-hiv-h-de40.html)|
|HIV.H.DE41|HIV treatment outcome|The outcome for the client which is used for reporting retention/attrition.|string|[Observation.value[x]](StructureDefinition-hiv-h-de41.html)|
|HIV.H.DE46|Date patient lost to follow-up|Date patient was lost to follow-up (LTFU)|string|[Observation.value[x]](StructureDefinition-hiv-h-de46.html)|
|HIV.H.DE48|Date HIV treatment outcome changed|The date on which the client's outcome (lost to follow-up, transferred out, death (documented), or refused (stopped) treatment) changed|string|[Observation.value[x]](StructureDefinition-hiv-h-de48.html)|
|HIV.H.DE49|Transfer confirmed|Select if transfer to another facility is confirmed|string|[Observation.value[x]](StructureDefinition-hiv-h-de49.html)|
|HIV.H.DE50|Transfer to facility|Name of health facility client was transferred to|string|[Observation.value[x]](StructureDefinition-hiv-h-de50.html)|
|HIV.H.DE51|Date of transfer out|The date the client transferred out of the facility to be provided with care at another facility|string|[Observation.value[x]](StructureDefinition-hiv-h-de51.html)|
|HIV.H.DE52|Adherence assessment|Whether client is adherent or not to ART regimen per national guidelines (immunological or virological monitoring)|string|[Observation.value[x]](StructureDefinition-hiv-h-de52.html)|
|HIV.H.DE9|Other follow-up reason (specify)|Client was followed up for another reason (specify)|string|[Observation.value[x]](StructureDefinition-hiv-h-de9.html)|
|HIV.I.DE1|Emergency referral|Referral for urgent care|string|[Observation.value[x]](StructureDefinition-hiv-i-de1.html)|
|HIV.I.DE10|Date of scheduled referral appointment|When the referral is scheduled|string|[Observation.value[x]](StructureDefinition-hiv-i-de10.html)|
|HIV.I.DE11|Location of scheduled referral appointment|Where the client is being referred to|string|[Observation.value[x]](StructureDefinition-hiv-i-de11.html)|
|HIV.I.DE12|Date referral was made|The date the referral was made|string|[Observation.value[x]](StructureDefinition-hiv-i-de12.html)|
|HIV.I.DE13|Provider who made referral|The name of the provider who made the referral|string|[Observation.value[x]](StructureDefinition-hiv-i-de13.html)|
|HIV.I.DE14|Provider's facility|Facility client is being referred from|string|[Observation.value[x]](StructureDefinition-hiv-i-de14.html)|
|HIV.I.DE15|Provider's telephone number|The contact details of the provider making the referral|string|[Observation.value[x]](StructureDefinition-hiv-i-de15.html)|
|HIV.I.DE16|Referral notes|Any additional relevant details of clinical significance for the referral facility to provide quality care|string|[Observation.value[x]](StructureDefinition-hiv-i-de16.html)|
|HIV.I.DE17|Client history summary|With interoperable systems, the provider receiving the referral should be able to access the client's health record digitally. However, in the absence of this, the referral provider should receive a summary of the client's health records that includes the client's history, medications, medications prescribed or dispensed, reported issues and concerns, and any other relevant clinical information the health care provider had already obtained.|string|[Observation.value[x]](StructureDefinition-hiv-i-de17.html)|
...
|HIV.I.DE8|Referral for other general services (specify)|If none of the reasons above apply, specify the reason(s)|string|[Observation.value[x]](StructureDefinition-hiv-i-de8.html)|
|HIV.I.DE9|Any treatment given before referral|If client was referred, was any treatment provided before referral?|string|[Observation.value[x]](StructureDefinition-hiv-i-de9.html)|
|HIV.PRV.DE10|Date accessed HIV prevention intervention|Date the client accessed HIV prevention intervention|string|[Observation.value[x]](StructureDefinition-hiv-prv-de10.html)|
|HIV.PRV.DE11|HIV status of contact|The HIV status of the client's contact|string|[Observation.value[x]](StructureDefinition-hiv-prv-de11.html)|
|HIV.PRV.DE15|Date injecting equipment provided|Date client was provided with injecting equipment|string|[Observation.value[x]](StructureDefinition-hiv-prv-de15.html)|
|HIV.PRV.DE16|Number of needles-syringes provided|Number of needles-syringes provided to client|string|[Observation.value[x]](StructureDefinition-hiv-prv-de16.html)|
|HIV.PRV.DE17|Date OAMT initiated|Date client initiated opioid agonist maintenance treatment (OAMT)|string|[Observation.value[x]](StructureDefinition-hiv-prv-de17.html)|
|HIV.PRV.DE18|Date OAMT dose received|Date client received opioid agonist maintenance treatment (OAMT) dose|string|[Observation.value[x]](StructureDefinition-hiv-prv-de18.html)|
|HIV.PRV.DE19|Date OAMT take-away dose(s) dispensed|Date the client was dispensed opioid agonist maintenance treatment (OAMT) take-away dose(s)|string|[Observation.value[x]](StructureDefinition-hiv-prv-de19.html)|
|HIV.PRV.DE2|HIV prevention intervention|HIV prevention intervention that client accessed|string|[Observation.value[x]](StructureDefinition-hiv-prv-de2.html)|
|HIV.PRV.DE20|Currently on OAMT|Client is currently on opioid agonist maintenance treatment (OAMT) at reporting date, defined according to country/program to account for medication dispensed and LTFU criterion|string|[Observation.value[x]](StructureDefinition-hiv-prv-de20.html)|
|HIV.PRV.DE21|Retained on OAMT|Client is retained on opioid agonist maintenance treatment (OAMT) at reporting date, defined according to country/program to account for medication dispensed and LTFU criterion|string|[Observation.value[x]](StructureDefinition-hiv-prv-de21.html)|
|HIV.PRV.DE22|Client being inducted on OAMT|Client is currently being inducted on opioid agonist maintenance treatment (OAMT), defined according to country/program|string|[Observation.value[x]](StructureDefinition-hiv-prv-de22.html)|
|HIV.PRV.DE23|Client on reducing doses of OAMT|Client is current on reducing doses of opioid agonist maintenance treatment (OAMT), defined according to country/program|string|[Observation.value[x]](StructureDefinition-hiv-prv-de23.html)|
|HIV.PRV.DE24|Date first maintenance dose received|First date on which client received maintenance dose|string|[Observation.value[x]](StructureDefinition-hiv-prv-de24.html)|
|HIV.PRV.DE25|Date of loss to follow-up or OAMT stopped|Date of loss to follow-up or opioid agonist maintenance treatment (OAMT) stopped|string|[Observation.value[x]](StructureDefinition-hiv-prv-de25.html)|
