...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/hiv/ValueSet/HIV.B.DE293 | *Version*:0.4.4 |
| Active as of 2026-03-05 | *Computable Name*:HIVBDE293 |
...
### GET /ValueSet-HIV.B.DE293.schema.json

#### JSON Schema definition for the enumeration ValueSet-HIV.B.DE293

This endpoint serves the JSON Schema definition for the enumeration ValueSet-HIV.B.DE293.

## Schema Definition

### ValueSet-HIV.B.DE293
...
```json
{
  ...
  "url" : "http://smart.who.int/hiv/ValueSet/HIV.B.DE293",
  "version" : "0.4.4",
  "name" : "HIVBDE293",
